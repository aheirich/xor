...
xW2 = __a1.x[0] * W2[0][0] + __a1.x[1] * W2[0][1] + __a1.x[2] * W2[0][2] + __a1.x[3] * W2[0][3] + __a1.x[4] * W2[0][4] + __a1.x[5] * W2[0][5] + __a1.x[6] * W2[0][6] + __a1.x[7] * W2[0][7] + __a1.x[8] * W2[0][8] + __a1.x[9] * W2[0][9];
print("x W2 = ", xW2)
